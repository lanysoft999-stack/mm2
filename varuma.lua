-- [Varuma Hack v5.2 - 2s Death FX v2, V Logo, Trail Behind Back, Fat Tracers]
...
-- ==================== SELF TRAIL (behind back, fades when idle) ====================
...
-- Player Trails card (updated — color cycle added)
AddCard("visuals", "Player Trails", "line behind back, fades when idle", false,
